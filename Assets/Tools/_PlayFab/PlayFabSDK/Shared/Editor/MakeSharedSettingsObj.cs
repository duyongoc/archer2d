...
public class MakeScriptableObject
{
    ...
    public static void MakePlayFabSharedSettings()
    {
        ...
        AssetDatabase.CreateAsset(asset, "Assets/Tools/_PlayFab/PlayFabSdk/Shared/Public/Resources/PlayFabSharedSettings.asset"); // TODO: Path should not be hard coded
