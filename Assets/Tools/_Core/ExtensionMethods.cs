...
public static class ExtensionMethods 
{
    ...
    public static Transform SpawnToGarbage(this Transform prefab, Vector3 position, Quaternion quaternion)
    {
        return PoolGarbage.Instance.Spawn(prefab, position, quaternion);
    }

    public static Transform SpawnToGarbage(this Transform prefab)
    {
        return PoolGarbage.Instance.Spawn(prefab);
    }
